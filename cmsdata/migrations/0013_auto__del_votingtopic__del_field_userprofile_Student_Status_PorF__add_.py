...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'UserProfile.Student_Status_PorF'
        db.delete_column(u'cmsdata_userprofile', 'Student_Status_PorF')

        # Adding field 'UserProfile.Student_If_Fail'
        db.add_column(u'cmsdata_userprofile', 'Student_If_Fail',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'UserProfile.Student_Status_PorF'
        db.add_column(u'cmsdata_userprofile', 'Student_Status_PorF',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'UserProfile.Student_If_Fail'
        db.delete_column(u'cmsdata_userprofile', 'Student_If_Fail')
    ...
    models = {
        ...
        u'cmsdata.course': {
            ...
            'Course_Students': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['auth.Group']", 'null': 'True', 'blank': 'True'}),
            'Course_Teachers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['auth.User']", 'symmetrical': 'False'}),
            'Course_expected_classes': ('django.db.models.fields.IntegerField', [], {'default': '40', 'max_length': '10'}),
        ...
        u'cmsdata.userprofile': {
            ...
            'Student_If_Fail': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
