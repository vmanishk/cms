...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.if_first_login'
        db.add_column(u'cmsdata_userprofile', 'if_first_login',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.if_first_login'
        db.delete_column(u'cmsdata_userprofile', 'if_first_login')
