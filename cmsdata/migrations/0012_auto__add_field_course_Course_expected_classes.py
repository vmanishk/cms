...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.Course_expected_classes'
        db.add_column(u'cmsdata_course', 'Course_expected_classes',
                      self.gf('django.db.models.fields.IntegerField')(default=40, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.Course_expected_classes'
        db.delete_column(u'cmsdata_course', 'Course_expected_classes')
