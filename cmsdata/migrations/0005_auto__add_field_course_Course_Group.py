...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.Course_Group'
        db.add_column(u'cmsdata_course', 'Course_Group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True),
                      keep_default=False)

        # Removing M2M table for field Course_Group on 'Course'
        db.delete_table(db.shorten_name(u'cmsdata_course_Course_Group'))

        # Adding M2M table for field Course_Prerequisites on 'Course'
        m2m_table_name = db.shorten_name(u'cmsdata_course_Course_Prerequisites')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_course', models.ForeignKey(orm[u'cmsdata.course'], null=False)),
            ('to_course', models.ForeignKey(orm[u'cmsdata.course'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_course_id', 'to_course_id'])


    def backwards(self, orm):
        # Deleting field 'Course.Course_Group'
        db.delete_column(u'cmsdata_course', 'Course_Group_id')

        # Adding M2M table for field Course_Group on 'Course'
        m2m_table_name = db.shorten_name(u'cmsdata_course_Course_Group')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('course', models.ForeignKey(orm[u'cmsdata.course'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['course_id', 'group_id'])

        # Removing M2M table for field Course_Prerequisites on 'Course'
        db.delete_table(db.shorten_name(u'cmsdata_course_Course_Prerequisites'))
    ...
    models = {
        ...
        u'cmsdata.course': {
            'Course_Group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.Group']", 'null': 'True'}),
