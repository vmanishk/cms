...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.Course_Students'
        db.delete_column(u'cmsdata_course', 'Course_Students_id')

        # Adding M2M table for field Course_Students on 'Course'
        m2m_table_name = db.shorten_name(u'cmsdata_course_Course_Students')
    ...
    def backwards(self, orm):
        # Adding field 'Course.Course_Students'
        db.add_column(u'cmsdata_course', 'Course_Students',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.Group'], null=True),
                      keep_default=False)

        # Removing M2M table for field Course_Students on 'Course'
        db.delete_table(db.shorten_name(u'cmsdata_course_Course_Students'))
