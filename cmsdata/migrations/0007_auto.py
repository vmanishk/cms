...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field Course_Teachers on 'Course'
        m2m_table_name = db.shorten_name(u'cmsdata_course_Course_Teachers')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field Course_Teachers on 'Course'
        db.delete_table(db.shorten_name(u'cmsdata_course_Course_Teachers'))
